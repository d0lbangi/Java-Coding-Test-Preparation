...
class AVLTree {
    ...
    public Node2 rightRotate(Node2 node) {
        Node2 lNode = node.left;
    ...
    public Node2 leftRotate(Node2 node) {
        Node2 rNode = node.right;
    ...
    public Node2 lrRotate(Node2 node) {
        node.left = leftRotate(node.left);
        return rightRotate(node);
    }

    public Node2 rlRotate(Node2 node) {
    ...
    public Node2 insert(Node2 node, int key) {
        if (node == null) {
